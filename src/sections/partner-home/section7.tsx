  ...
  return (
   ...
   position:'relative',
    ...
    bgcolor: "#fff",display:'flex', alignItems:"end"}}>
        ...
        <Box sx={{mx:'auto', transform:{xs:` skewX(0deg) rotateX(0deg)`,md:` skewX(165deg) rotateX(15deg)`},bgcolor:"#faaf1b", width:'100%',maxWidth:'811px', height:{xs:300,md:'320px'},borderRadius:6,}}>
        ...
        <Card raised sx={{borderRadius:4, width:'100%', maxWidth:'350px', position:'absolute',transform:{md:'translateX(50%)',xs:'translateX(0%)'}, bottom:60}}>
          ...
          <FormControlLabel sx={{pb:1}} labelPlacement="start" label={`${t('Global.Section6.terms')}`} control={<Checkbox color="warning" />} />
          <br />
          <Button variant="contained" color="warning" sx={{alignSelf:'flex-start',boxShadow:3, borderRadius:2}}>{`${t('Global.Section6.send')}`}</Button>
