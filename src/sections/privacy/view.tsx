  ...
  return (
    <Container sx={{ mb: 7 }}>
      ...
      <Box sx={{ my: 2 }}>
        ...
        >
          ...
          <ListItem dense sx={{ display: "list-item", p: 0, my: 0, py: 1 }}>
            <Typography variant="body1" color="primary.dark">
              ...
              refers to Maharatona, the software program provided by the
              Company.
          ...
          <ListItem dense sx={{ display: "list-item", p: 0, my: 0, py: 1 }}>
            <Typography variant="body1" color="primary.dark">
              ...
              {` (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ESTABLISHMENT MAHARAT AL-TUGHIYR FOR ADVERTISING , 7030 Al Rumman Street, Secondary Number:3765, Al Yasmeen District Riyadh 13322 .`}
            </Typography>
          </ListItem>
          <ListItem dense sx={{ display: "list-item", p: 0, my: 0, py: 1 }}>
            <Typography variant="body1" color="primary.dark">
          ...
          <ListItem dense sx={{ display: "list-item", p: 0, my: 0 }}>
            <Typography variant="body1" color="primary.dark">
              <strong>Website </strong>
              refers to Maharatona, accessible from
              <Link
                sx={{ mx: 1 }}
                variant="body1"
                color="primary.dark"
                href="https://maharatona.com/"
              >
                https://maharatona.com/
              </Link>
            </Typography>
          </ListItem>
          <ListItem dense sx={{ display: "list-item", p: 0, my: 0, py: 1 }}>
        ...
        <Typography variant="body1" color="primary.dark" sx={{fontWeight: "600", my: 2 }}>
